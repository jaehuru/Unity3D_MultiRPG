    ...
    public class CombatManager : NetworkBehaviour
    {
        ...
        private ulong[] _singleClientTarget = new ulong[1];
...

                {
                    ...
                    // _vfxManager = VFXManager.Instance; // Awake에서 캐싱하는 대신, 필요할 때마다 참조
...

                {
                    ...
                    // Just-In-Time 참조: 필요할 때 VFXManager 인스턴스를 다시 확인하고 가져옵니다.
...

                    {
                        ...
                        Debug.LogError("[CombatManager] VFXManager.Instance is still null. Cannot show floating text.");
